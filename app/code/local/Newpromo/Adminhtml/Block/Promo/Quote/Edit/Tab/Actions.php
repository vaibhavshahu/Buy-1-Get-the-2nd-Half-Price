 ...
 */
class Newpromo_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions
        ...
        $fieldset->addField('simple_action', 'select', array(
            ...
            'options'    => array(
                ...
                Mage_SalesRule_Model_Rule::BUY_X_GET_Y_ACTION => Mage::helper('salesrule')->__('Buy X get Y free (discount amount is Y)'),
				        Newpromo_SalesRule_Model_Rule::BUY_1_GET_THE_2ND_HALF_PRICE_ACTION => Mage::helper('salesrule')->__('Buy 1 Get the 2nd Half Price'), // Add your action
            ),
        ));
